...
--   2. npm run seed:resources:kentucky        — generate Kentucky SQL from data/kentucky-resources.csv
--   3. supabase/seed-kentucky-resources.sql   — load Kentucky resources
