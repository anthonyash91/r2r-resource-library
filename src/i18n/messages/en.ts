export const en = {
  ...
  facility: {
    sessionRequiredTitle: "Facility link required",
    sessionRequired: "Open the personal link from your facility to sign in or create an account.",
    ...
    signupSubtitle:
      "No email confirmation is needed on this device. You can email your saved resources to any address.",
    loginTitle: "Sign in",
    loginSubtitle: "Use the email and password you created for this facility link.",
    accountEmailLabel: "Account email",
    accountEmailHint:
      "Use your email or a family member's email you can access later for password recovery.",
    ...
    accountAlreadyExistsDesc: "This facility link already has an account. Sign in to continue.",
    ...
    accountAlreadyExists: "An account already exists for this facility link.",
    pinMismatch: "This account does not match your facility link. Use your personal link to sign in.",
    forgotPassword: "Forgot password?",
    resetTitle: "Reset your password",
    resetSubtitle: "Answer both security questions you set when you created your account.",
