export const en = {
  ...
  forCaseWorkers: "For case workers",
  about: "About",
  saved: "Saved",
  ...
  footer: {
    ...
    faqLink: "FAQ page",
    copyright: "© {year} Road to Reentry. A registered 501(c)(3) nonprofit.",
    findResources: "Find Resources",
  ...
  libraryDisclaimer: {
    footer:
      "Road to Reentry is a free resource library, not a service provider. We do not own, operate, or manage the resources listed on this site.",
    detail:
      "Listings are provided for discovery only. We do not own, operate, or manage any organization listed here. Contact each provider directly to confirm eligibility, hours, and services.",
  },
  ...
  promoBar: {
    message: "A free, confidential nonprofit service · In crisis? Call or text",
    crisisNumber: "988",
  },

  home: {
    heroHeadline: "Building a stronger future after incarceration.",
    heroSubheadline:
      "Road to Reentry connects you with trusted resources for housing, employment, education, and recovery — all in one place, always free.",
    heroHighlight: "incarceration.",
    heroNeedPlaceholder: "What do you need? (e.g. housing)",
    heroZipPlaceholder: "ZIP code",
    heroSearchPlaceholder: "Search housing, jobs, healthcare, or ZIP code...",
    popular: "Popular:",
    popularHousingTonight: "Housing tonight",
    popularGetId: "Get an ID",
    popularFindWork: "Find work",
    ...
    servicesSubtitle:
      "Verified resources gathered by case workers, so the first step after release isn't a dead end.",
    serviceHousingDesc:
      "Transitional housing and landlords who rent fairly to returning citizens.",
    serviceEmploymentDesc:
      "Fair-chance employers, job training, and free help building a resume.",
    serviceRecoveryTitle: "Recovery & health",
    serviceRecoveryDesc:
      "Substance recovery, counseling, clinics, and peer support groups.",
    serviceLegalTitle: "Legal aid & rights",
    serviceLegalDesc: "Expungement, parole questions, IDs, and free legal counsel.",
    ...
    howItWorksIntro1:
      "Three steps, no paperwork to start. Search by what you need, see verified options nearby, and take the next step on your own terms.",
    howItWorksIntro2:
      "No account is ever required — but you can make a free one to save resources and track progress.",
    howItWorksSubtitle: "Three simple steps to find the support you need.",
    stepTellNeedTitle: "Tell us what you need",
    stepTellNeedDesc: "Search by need and ZIP code.",
    stepVerifiedTitle: "See verified options nearby",
    stepVerifiedDesc: "Hours, eligibility, how to apply.",
    stepNextTitle: "Take the next step",
    stepNextDesc: "Call, save, or get directions.",
    ...
    startSearching: "Start now",
    reentryPlanTitle: "My reentry plan",
    planItemId: "Get state ID",
    planItemHousing: "Apply for housing",
    planItemHealth: "Enroll in health coverage",
    planItemWork: "Find work",
    planItemBank: "Open a bank account",
    planItemMentor: "Connect with a mentor",
    planInProgress: "in progress",
    realOutcomesTitle: "Real outcomes",
    realOutcomesDesc:
      "People who leave jail with a clear reentry plan have a better chance of staying housed, finding work, and building stability during the difficult first year after release.",
    statEmployment: "more likely to find employment in 6 months",
    statEmploymentLine1: "more likely to find",
    statEmploymentLine2: "employment in 6 months",
    statHomelessness: "less likely to experience homelessness",
    statHomelessnessLine1: "less likely to",
    statHomelessnessLine2: "experience homelessness",
    realOutcomesSource:
      "Vs. standard services, among participants in a randomized evaluation of Minnesota's Comprehensive Offender Reentry Plan.",
    realOutcomesSourceLink: "Source: MN DOC, 2010",
    differentTitle: "What makes us different",
    differentSubtitle:
      "Not just another list of links. Every resource is checked, current, and explained in plain language.",
    differentVerifiedTitle: "Verified, not guessed",
    differentVerifiedDesc:
      "Case workers confirm every listing — hours, eligibility, and how to apply.",
    differentPrivateTitle: "Private by default",
    differentPrivateDesc:
      "No account needed, no data sold. Your search is yours alone.",
    differentFreeTitle: "Always free",
    differentFreeDesc:
      "No fees, no ads. Built with people who've been there — not for profit.",
    mockCategoryHousing: "HOUSING",
    mockVerified: "Verified",
    mockResourceName: "New Hope Transitional Housing",
    mockDistance: "0.4 mi",
    mockOpenNow: "Open now",
    mockBeds: "6 beds today",
    mockTagFairChance: "Fair-chance",
    mockTagNoFee: "No fee",
    mockTagReferrals: "Accepts referrals",
    mockCallNow: "Call now",
    mockSave: "Save",
    mockCheckedBadge: "Checked this month",
    caseWorkerTitle: "Manage your whole caseload in one place",
    caseWorkerSubtitle:
      "For case workers: track each client's plan, send verified referrals, and prepare people for release — all in one shared workspace.",
    caseWorkerFeature1Title: "Track every client's progress",
    caseWorkerFeature1Desc: "See each reentry plan and what's done at a glance.",
    caseWorkerFeature2Title: "Send referrals in two taps",
    caseWorkerFeature2Desc: "Connect clients to verified resources instantly.",
    caseWorkerFeature3Title: "Plan before release",
    caseWorkerFeature3Desc: "See what's available so the first day home isn't lost.",
    caseWorkerCta: "Request access",
    getListedTitle: "Run a program? Get listed.",
    getListedSubtitle:
      "Shelters, fair-chance employers, recovery programs, legal aid — if you help people rebuild after incarceration, we want you on the map.",
    getListedMockName: "Your Program Name",
    getListedMockCity: "Your city",
    getListedMockIntake: "Intake info",
    getListedPreviewBadge: "Live preview",
    getListedFreeTitle: "Free to list",
    getListedFreeDesc: "No cost, no catch. Adding your program takes just a few minutes.",
    getListedVerifiedTitle: "Verified by case workers",
    getListedVerifiedDesc:
      "We confirm your details so people arrive with the right expectations.",
    getListedNearbyTitle: "Seen by people nearby",
    getListedNearbyDesc: "Show up in searches for the people who need you most.",
    getListedCta: "Add your organization",
    getListedHowVerification: "How verification works",
    possibleTitle: "What's possible after release",
    possibleSubtitle:
      "Real support for the things that rebuild a life — a home, a job, family, and a fresh legal start.",
    possibleHousing: "A place of your own",
    possibleHousingDesc: "Transitional housing and landlords who rent fairly.",
    possibleEmployment: "A job that hires fairly",
    possibleEmploymentDesc: "Fair-chance employers and training.",
    possibleFamily: "Time with family",
    possibleFamilyDesc: "Recovery and counseling that keep you close.",
    possibleExpungement: "Expungement",
    possibleExpungementDesc: "Free legal aid to clear your record and move on.",
    possibleEducation: "Education",
    possibleEducationDesc: "GED programs and trades that open new doors.",
    exploreAllResources: "Explore all resources",
    coverageEyebrow: "Our reach",
    coverageRootedTitle: "Rooted across {count} states",
    coverageRootedDesc:
      "{count} vetted resources, concentrated where our partners are on the ground. We add new states as soon as we can verify local support — so no listing ever goes stale.",
    coverageLegendActive: "States we serve today",
    coverageLegendExpanding: "Expanding soon",
    coverageGrowCta: "Don't see your state? Tell us where to grow →",
    accountComparisonTitle: "Free to use — better with an account",
    accountComparisonSubtitle:
      "Search every resource without signing up. Create a free account when you want to save what you find and keep track of your progress — your information stays private either way.",
    noAccountLabel: "No account",
    browseFreely: "Browse freely",
    browseFreelyDesc: "use everything right away",
    freeAccountLabel: "Free account",
    freeForever: "Free, forever",
    freeForeverDesc: "save & track your progress",
    recommendedBadge: "Recommended",
    featureSearchAll: "Search every resource",
    featureHoursEligibility: "See hours, eligibility & contact info",
    featureDirections: "Get directions & call directly",
    featureSavingNA: "Saving & progress tracking",
    featureChecklistNA: "Personalized checklist",
    everythingInBrowsing: "Everything in browsing, plus:",
    featureSaveOrganize: "Save & organize resources",
    featureTrackPlan: "Track your reentry plan & progress",
    featurePersonalizedChecklist: "Personalized first-30-days checklist",
    featureReminders: "Reminders for appointments",
    startBrowsing: "Start browsing",
    createFreeAccountArrow: "Create a free account →",
    faqSectionTitle: "Frequently asked questions",
    faqSectionSubtitle:
      "Straight answers, in plain language — no account or jargon required.",
    featuredEyebrow: "Hand-picked this week",
    featuredTitle: "Featured resources",
    featuredSubtitle:
      "Verified, in-demand programs our case workers recommend most right now.",
    featuredDetails: "Details",
    featuredByAppointment: "By appointment",
    viewAllResources: "View all resources",
    viewAllResourcesArrow: "View all resources →",
  ...
  pathways: {
    ...
    firstWeek: {
      ...
      introByState: {
        ...
        northCarolina:
          "Seven practical steps for your first days home in North Carolina. Each step links to real resources from our directory.",
        virginia:
          "Seven practical steps for your first days home in Virginia. Each step links to real resources from our directory.",
        southCarolina:
          "Seven practical steps for your first days home in South Carolina. Each step links to real resources from our directory.",
        alabama:
          "Seven practical steps for your first days home in Alabama. Each step links to real resources from our directory.",
        arizona:
          "Seven practical steps for your first days home in Arizona. Each step links to real resources from our directory.",
        florida:
          "Seven practical steps for your first days home in Florida. Each step links to real resources from our directory.",
        mississippi:
          "Seven practical steps for your first days home in Mississippi. Each step links to real resources from our directory.",
        wisconsin:
          "Seven practical steps for your first days home in Wisconsin. Each step links to real resources from our directory.",
        texas:
          "Seven practical steps for your first days home in Texas. Each step links to real resources from our directory.",
      },
      steps: {
        "crisis-support": {
