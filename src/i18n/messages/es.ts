...
export const es = {
  ...
  facility: {
    sessionRequiredTitle: "Se requiere el enlace de la instalación",
    sessionRequired:
      "Abra el enlace personal de su instalación para iniciar sesión o crear una cuenta.",
    ...
    signupSubtitle:
      "No se necesita confirmación de correo en este dispositivo. Puede enviar sus recursos guardados a cualquier dirección.",
    loginTitle: "Iniciar sesión",
    loginSubtitle: "Use el correo y la contraseña que creó para este enlace de la instalación.",
    accountEmailLabel: "Correo de la cuenta",
    accountEmailHint:
      "Use su correo o el de un familiar al que pueda acceder después para recuperar la contraseña.",
    ...
    accountAlreadyExistsDesc:
      "Este enlace de la instalación ya tiene una cuenta. Inicie sesión para continuar.",
    ...
    accountAlreadyExists: "Ya existe una cuenta para este enlace de la instalación.",
    pinMismatch:
      "Esta cuenta no coincide con su enlace de la instalación. Use su enlace personal para iniciar sesión.",
