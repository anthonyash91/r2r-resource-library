...
export const es = {
  ...
  nav: {
    ...
    forCaseWorkers: "Para trabajadores sociales",
    about: "Acerca de",
    saved: "Guardados",
    dashboard: "Mi panel",
  ...
  footer: {
    ...
    organizationHeading: "Organización",
    getHelpHeading: "Obtener ayuda",
    helpHeading: "Ayuda",
    ...
    copyright: "© {year} Road to Reentry. Una organización sin fines de lucro 501(c)(3) registrada.",
    findResources: "Buscar recursos",
  ...
  promoBar: {
    message:
      "Un servicio gratuito y confidencial sin fines de lucro · ¿En crisis? Llame o envíe un mensaje al",
    crisisNumber: "988",
  },

  home: {
    heroHeadline: "Construir un futuro más sólido después de la encarcelación.",
    heroSubheadline:
      "Road to Reentry le conecta con recursos confiables para vivienda, empleo, educación y recuperación — todo en un solo lugar, siempre gratis.",
    heroHighlight: "encarcelación.",
    heroNeedPlaceholder: "¿Qué necesita? (p. ej., vivienda)",
    heroZipPlaceholder: "Código postal",
    heroSearchPlaceholder: "Busque vivienda, empleo, salud o código postal...",
    popular: "Popular:",
    popularHousingTonight: "Vivienda esta noche",
    popularGetId: "Obtener una identificación",
    popularFindWork: "Encontrar trabajo",
    ...
    servicesSubtitle:
      "Recursos verificados reunidos por trabajadores sociales, para que el primer paso después de la liberación no sea un callejón sin salida.",
    serviceHousingDesc:
      "Vivienda transitoria y propietarios que alquilan de manera justa a personas que regresan.",
    serviceEmploymentDesc:
      "Empleadores de segunda oportunidad, capacitación laboral y ayuda gratuita para crear un currículum.",
    serviceRecoveryTitle: "Recuperación y salud",
    serviceRecoveryDesc:
      "Recuperación de sustancias, consejería, clínicas y grupos de apoyo entre pares.",
    serviceLegalTitle: "Asistencia legal y derechos",
    serviceLegalDesc:
      "Eliminación de antecedentes, preguntas sobre la libertad condicional, identificaciones y asesoría legal gratuita.",
    ...
    howItWorksIntro1:
      "Tres pasos, sin papeleo para empezar. Busque lo que necesita, vea opciones verificadas cerca y dé el siguiente paso a su manera.",
    howItWorksIntro2:
      "Nunca se requiere una cuenta — pero puede crear una gratis para guardar recursos y seguir su progreso.",
    howItWorksSubtitle: "Tres pasos sencillos para encontrar el apoyo que necesita.",
    stepTellNeedTitle: "Díganos qué necesita",
    stepTellNeedDesc: "Busque por necesidad y código postal.",
    stepVerifiedTitle: "Vea opciones verificadas cerca",
    stepVerifiedDesc: "Horarios, elegibilidad, cómo solicitar.",
    stepNextTitle: "Dé el siguiente paso",
    stepNextDesc: "Llame, guarde o obtenga indicaciones.",
    ...
    startSearching: "Comenzar ahora",
    reentryPlanTitle: "Mi plan de reinserción",
    planItemId: "Obtener identificación estatal",
    planItemHousing: "Solicitar vivienda",
    planItemHealth: "Inscribirse en cobertura de salud",
    planItemWork: "Encontrar trabajo",
    planItemBank: "Abrir una cuenta bancaria",
    planItemMentor: "Conectar con un mentor",
    planInProgress: "en progreso",
    realOutcomesTitle: "Resultados reales",
    realOutcomesDesc:
      "Las personas que salen de la cárcel con un plan claro de reinserción tienen más probabilidades de mantener vivienda, encontrar trabajo y construir estabilidad durante el difícil primer año después de la liberación.",
    statEmployment: "más probabilidad de encontrar empleo en 6 meses",
    statEmploymentLine1: "más probabilidad de encontrar",
    statEmploymentLine2: "empleo en 6 meses",
    statHomelessness: "menos probabilidad de experimentar sin hogar",
    statHomelessnessLine1: "menos probabilidad de",
    statHomelessnessLine2: "experimentar sin hogar",
    realOutcomesSource:
      "Frente a servicios estándar, entre participantes en una evaluación aleatoria del Plan Integral de Reinserción de Minnesota.",
    realOutcomesSourceLink: "Fuente: MN DOC, 2010",
    differentTitle: "Lo que nos hace diferentes",
    differentSubtitle:
      "No es solo otra lista de enlaces. Cada recurso está verificado, actualizado y explicado en lenguaje sencillo.",
    differentVerifiedTitle: "Verificado, no adivinado",
    differentVerifiedDesc:
      "Los trabajadores sociales confirman cada listado — horarios, elegibilidad y cómo solicitar.",
    differentPrivateTitle: "Privado por defecto",
    differentPrivateDesc:
      "No se necesita cuenta, no vendemos datos. Su búsqueda es solo suya.",
    differentFreeTitle: "Siempre gratis",
    differentFreeDesc:
      "Sin tarifas, sin anuncios. Creado con personas que han estado allí — no por lucro.",
    mockCategoryHousing: "VIVIENDA",
    mockVerified: "Verificado",
    mockResourceName: "Vivienda Transitoria New Hope",
    mockDistance: "0.4 mi",
    mockOpenNow: "Abierto ahora",
    mockBeds: "6 camas hoy",
    mockTagFairChance: "Segunda oportunidad",
    mockTagNoFee: "Sin costo",
    mockTagReferrals: "Acepta referencias",
    mockCallNow: "Llamar ahora",
    mockSave: "Guardar",
    mockCheckedBadge: "Verificado este mes",
    caseWorkerTitle: "Administre toda su carga de casos en un solo lugar",
    caseWorkerSubtitle:
      "Para trabajadores sociales: siga el plan de cada cliente, envíe referencias verificadas y prepare a las personas para la liberación — todo en un espacio compartido.",
    caseWorkerFeature1Title: "Siga el progreso de cada cliente",
    caseWorkerFeature1Desc: "Vea cada plan de reinserción y lo completado de un vistazo.",
    caseWorkerFeature2Title: "Envíe referencias en dos toques",
    caseWorkerFeature2Desc: "Conecte clientes con recursos verificados al instante.",
    caseWorkerFeature3Title: "Planifique antes de la liberación",
    caseWorkerFeature3Desc: "Vea qué hay disponible para que el primer día en casa no se pierda.",
    caseWorkerCta: "Solicitar acceso",
    getListedTitle: "¿Dirige un programa? Aparezca en el mapa.",
    getListedSubtitle:
      "Refugios, empleadores de segunda oportunidad, programas de recuperación, asistencia legal — si ayuda a personas a reconstruirse después de la encarcelación, queremos incluirlo.",
    getListedMockName: "Nombre de su programa",
    getListedMockCity: "Su ciudad",
    getListedMockIntake: "Información de admisión",
    getListedPreviewBadge: "Vista previa en vivo",
    getListedFreeTitle: "Gratis para listar",
    getListedFreeDesc: "Sin costo, sin trucos. Agregar su programa toma solo unos minutos.",
    getListedVerifiedTitle: "Verificado por trabajadores sociales",
    getListedVerifiedDesc:
      "Confirmamos sus datos para que las personas lleguen con las expectativas correctas.",
    getListedNearbyTitle: "Visible para personas cercanas",
    getListedNearbyDesc: "Aparezca en búsquedas de quienes más lo necesitan.",
    getListedCta: "Agregar su organización",
    getListedHowVerification: "Cómo funciona la verificación",
    possibleTitle: "Lo que es posible después de la liberación",
    possibleSubtitle:
      "Apoyo real para reconstruir una vida — un hogar, un trabajo, la familia y un nuevo comienzo legal.",
    possibleHousing: "Un lugar propio",
    possibleHousingDesc: "Vivienda transitoria y propietarios que alquilan de manera justa.",
    possibleEmployment: "Un trabajo que contrata de manera justa",
    possibleEmploymentDesc: "Empleadores de segunda oportunidad y capacitación.",
    possibleFamily: "Tiempo con la familia",
    possibleFamilyDesc: "Recuperación y consejería que lo mantienen cerca.",
    possibleExpungement: "Eliminación de antecedentes",
    possibleExpungementDesc: "Asistencia legal gratuita para limpiar su historial y seguir adelante.",
    possibleEducation: "Educación",
    possibleEducationDesc: "Programas GED y oficios que abren nuevas puertas.",
    exploreAllResources: "Explorar todos los recursos",
    coverageEyebrow: "Nuestro alcance",
    coverageRootedTitle: "Arraigados en {count} estados",
    coverageRootedDesc:
      "{count} recursos verificados, concentrados donde nuestros socios están en el terreno. Agregamos nuevos estados tan pronto como podemos verificar el apoyo local — para que ningún listado quede desactualizado.",
    coverageLegendActive: "Estados que servimos hoy",
    coverageLegendExpanding: "Próximamente",
    coverageGrowCta: "¿No ve su estado? Díganos dónde crecer →",
    accountComparisonTitle: "Gratis para usar — mejor con una cuenta",
    accountComparisonSubtitle:
      "Busque todos los recursos sin registrarse. Cree una cuenta gratuita cuando quiera guardar lo que encuentra y seguir su progreso — su información permanece privada de cualquier manera.",
    noAccountLabel: "Sin cuenta",
    browseFreely: "Navegue libremente",
    browseFreelyDesc: "use todo de inmediato",
    freeAccountLabel: "Cuenta gratuita",
    freeForever: "Gratis, para siempre",
    freeForeverDesc: "guarde y siga su progreso",
    recommendedBadge: "Recomendado",
    featureSearchAll: "Buscar todos los recursos",
    featureHoursEligibility: "Ver horarios, elegibilidad e información de contacto",
    featureDirections: "Obtener indicaciones y llamar directamente",
    featureSavingNA: "Guardar y seguimiento de progreso",
    featureChecklistNA: "Lista de verificación personalizada",
    everythingInBrowsing: "Todo lo de navegar, más:",
    featureSaveOrganize: "Guardar y organizar recursos",
    featureTrackPlan: "Seguir su plan de reinserción y progreso",
    featurePersonalizedChecklist: "Lista personalizada de los primeros 30 días",
    featureReminders: "Recordatorios de citas",
    startBrowsing: "Comenzar a navegar",
    createFreeAccountArrow: "Crear una cuenta gratuita →",
    faqSectionTitle: "Preguntas frecuentes",
    faqSectionSubtitle:
      "Respuestas directas, en lenguaje sencillo — sin cuenta ni jerga.",
    featuredEyebrow: "Seleccionados esta semana",
    featuredTitle: "Recursos destacados",
    featuredSubtitle:
      "Programas verificados y de alta demanda que nuestros trabajadores de casos recomiendan ahora mismo.",
    featuredDetails: "Detalles",
    featuredByAppointment: "Con cita",
    viewAllResources: "Ver todos los recursos",
    viewAllResourcesArrow: "Ver todos los recursos →",
    ...
    statCategories: "Categorías de servicio",
    statFree: "Gratis para usar",
    coverageMapTitle: "Recursos en todo el país",
    coverageMapSubtitle:
      "Listamos recursos de reinserción en {states} estados en {areas} condados y áreas de servicio. Explore el mapa para ver dónde hay ayuda cerca de usted.",
    coverageMapDesc:
      "Mapa interactivo de Estados Unidos que muestra condados y regiones donde se listan recursos de reinserción en nuestro directorio.",
    coverageMapAria: "Mapa de Estados Unidos con {count} marcadores de cobertura de recursos",
    coverageMapLegend:
      "Cada marcador indica un condado o región donde se listan recursos locales o regionales. Los estados resaltados incluyen recursos en nuestro directorio — seleccione un estado abajo para explorar.",
  ...
  pathways: {
    ...
    firstWeek: {
      ...
      introByState: {
        ...
        northCarolina:
          "Siete pasos prácticos para sus primeros días en casa en Carolina del Norte. Cada paso enlaza a recursos reales de nuestro directorio.",
        virginia:
          "Siete pasos prácticos para sus primeros días en casa en Virginia. Cada paso enlaza a recursos reales de nuestro directorio.",
        southCarolina:
          "Siete pasos prácticos para sus primeros días en casa en Carolina del Sur. Cada paso enlaza a recursos reales de nuestro directorio.",
        alabama:
          "Siete pasos prácticos para sus primeros días en casa en Alabama. Cada paso enlaza a recursos reales de nuestro directorio.",
        arizona:
          "Siete pasos prácticos para sus primeros días en casa en Arizona. Cada paso enlaza a recursos reales de nuestro directorio.",
        florida:
          "Siete pasos prácticos para sus primeros días en casa en Florida. Cada paso enlaza a recursos reales de nuestro directorio.",
        mississippi:
          "Siete pasos prácticos para sus primeros días en casa en Mississippi. Cada paso enlaza a recursos reales de nuestro directorio.",
        wisconsin:
          "Siete pasos prácticos para sus primeros días en casa en Wisconsin. Cada paso enlaza a recursos reales de nuestro directorio.",
        texas:
          "Siete pasos prácticos para sus primeros días en casa en Texas. Cada paso enlaza a recursos reales de nuestro directorio.",
      },
      steps: {
        "crisis-support": {
