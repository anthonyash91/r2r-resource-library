...
export const KENTUCKY_CATEGORIES: Category[] = [
  { id: "cat-ky-state-agency", name: "State Agency", slug: "state-agency", description: "Kentucky state government reentry programs and services", icon: "shield", sort_order: 1, is_active: true, created_at: now, updated_at: now },
  ...
  { id: "cat-ky-food-nutrition", name: "Food & Nutrition", slug: "food-nutrition", description: "Food assistance and nutrition programs", icon: "utensils", sort_order: 7, is_active: true, created_at: now, updated_at: now },
  ...
  { id: "cat-ky-education", name: "Education", slug: "education", description: "GED, job training, and credential programs during reentry", icon: "graduation-cap", sort_order: 13, is_active: true, created_at: now, updated_at: now },
  ...
  { id: "cat-ky-reentry-orgs", name: "Reentry Organizations", slug: "reentry-organizations", description: "Nonprofit reentry coalitions and community-based reentry programs", icon: "handshake", sort_order: 17, is_active: true, created_at: now, updated_at: now },
];
